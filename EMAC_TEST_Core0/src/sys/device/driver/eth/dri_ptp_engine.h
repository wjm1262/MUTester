...
//40M
#define PTP_REF_CLK_40M (40000000)
...
#define PTP_REF_CLK PTP_REF_CLK_40M
#define ADDEND_VAL (ADDEND_40M)
#define PPS_WIDTH_VAL PPS_WIDTH_40M
#define PPS_INTERVAL_VAL PPS_INTERVAL_40M

#define _4K_PPS_WIDTH_VAL (PPS_WIDTH_40M)/4000
#define _4K_PPS_INTERVAL_VAL (PPS_INTERVAL_40M)/4000
