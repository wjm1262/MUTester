...
#define pBANK1_ADDR_BASE        ((volatile unsigned short *)0XB4000000) //if define with (volatile unsigned int *),erro人！！！，why？？？

#define pBANK1_EMAC_CTR_BASE    ((volatile unsigned short *)0XB4080000)

#define pBANK1_ADHD_CTR_BASE    ((volatile unsigned short *)0XB4100000) //if define with (volatile unsigned int *),erro人！！！，why？？？

#define pBANK1_ADS1278_CTR_BASE ((volatile unsigned short *)0XB4180000)

#define pBANK1_AD7608_CTR_BASE  ((volatile unsigned short *)0XB4200000) //if define with (volatile unsigned int *),erro人！！！，why？？？
